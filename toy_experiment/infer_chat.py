...
def main():
    ...
    # ------------------- Load PRM ---------------------------
    prm_ckpt_path = "/home/leena/ccc_eval/mcts_prm/prm_training/checkpoints/contri/test_0723/best_prm.pt"
    ...
    # ------------------- Save Results ---------------------------
    results_path = f"/home/leena/ccc_eval/mcts_prm/test/gsm8k_qwen7b_bon_contri_infer_0724.json"
