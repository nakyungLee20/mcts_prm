...
def create_perturbed_steps(gold_steps: List[str], perturbation_type: str = "irrelevant") -> List[str]:
    ...
    if perturbation_type == "self_reflection":
        insert_position = random.randint(1, len(gold_steps))  # 1부터 시작 (0번째는 제외)
...
def main():
    ...
    # ------------------- Load PRM ---------------------------
    prm_ckpt_path = "/home/leena/ccc_eval/mcts_prm/prm_training/checkpoints/ori/test_0717/best_prm.pt"
    ...
    gen_cfg = GenerationConfig(
        temperature=0.4,  # 낮은 temperature로 일관된 출력
    ...
    for perturbation_type in ["self_reflection", "wrong_step", "irrelevant", "repetition"]:
        ...
        print("perturbation_avgs:",perturbation_avgs)
    ...
    results_path = f"/home/leena/ccc_eval/mcts_prm/inference/test/analysis_gsm8k_ori_0719.json"
