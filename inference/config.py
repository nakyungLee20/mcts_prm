class PRMConfig:
    ...
    reward_type:            str = "orimi"  # ori, contri, mi, cmi, orimi
    # PRM Model config 
    ...
    epochs:             int = 15       # 25 → 15로 감소 (early stopping 고려)
    # Misc config
    use_wandb:          bool = True
    wandb_project:      str = "mc_prm"
    run_name:           str = "test_1000_0717_3"
    checkpoint_dir:     str = "./checkpoints/orimi/test_0717"
    seed:               int = 42
    # Inference config
