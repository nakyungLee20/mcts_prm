        ...
        *,
        ...
        for e in entries:
            ...
            if self.reward_type == "contri":
                ...
                print("CMI as rewards")
            elif self.reward_type == "ori":
                rewards = o_rewards
                print("Original MC estimates as rewards")
            elif self.reward_type == "orimi":
                rewards = o_rewards + e["mi_filtered"]
                print("Original + MI as rewards")
            else:
                rewards = o_rewards
                print("Original as rewards")
